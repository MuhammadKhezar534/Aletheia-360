      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            exit={{ y: 50, opacity: 0 }}
            transition={{ type: "spring", damping: 25, stiffness: 300 }}
            className="relative w-full max-w-md bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-2xl overflow-hidden"
          >
            {/* Close button */}
            <motion.button
              whileHover={{ rotate: 90, scale: 1.1 }}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="Your Name"
                    required
                    className="w-full pl-10 pr-4 py-3 bg-gray-800 bg-opacity-70 rounded-lg border border-gray-600 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent"
                  />
                </motion.div>
