...
export const steps = [
  {
    ...
    title: "Prayer",
    description:
      "Simply talking to God about your struggles, hopes, and gratitude.",
  },
  {
    icon: <FaBookBible className="text-4xl" />,
    title: "Reading the Bible",
    description:
      "Learning about God's character, His promises, and how He wants us to live.",
  },
  {
    icon: <FaPeopleGroup className="text-4xl" />,
    title: "Community",
    description:
      "Finding other believers who can encourage you, such as a local church or faith-based group.",
  },
  {
    icon: <FaHandHoldingHeart className="text-4xl" />,
    title: "Obedience",
    description:
      "Listening to God's guidance and allowing His Spirit to shape your actions, attitudes, and relationships.",
  },
];
